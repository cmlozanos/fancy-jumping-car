const CACHE='fancy-jumping-car-20260925-3';
const ASSETS=['./','index.html','styles.css?v=20260925-3','learning-gate.js?v=20260925-3','src/main.js?v=20260925-3','src/performance.js','src/constants.js','src/portraits.js','src/physics.js','src/physics/carPhysics.js','src/physics/worldPhysics.js','vendor/three.module.js','vendor/addons/loaders/GLTFLoader.js','vendor/addons/utils/BufferGeometryUtils.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png',
